...
namespace ISurvived
{
    public class StoneFortCentral : MapClass
    {
        ...
        public override void LoadContent()
        {
            ...
            soldierAnimations = ContentLoader.LoadContent(content, "Maps\\History\\SoldierAnimations");
            ...
            switch (game.chapterState)
            {
                ...
                case Game1.ChapterState.chapterTwo:
                    ...
                    if (randomEnemy == 0)
                    {
                        ...
                        if (Game1.randomNumberGen.Next(3) > 0)
                        {
        ...
        public override void Update()
        {
            ...
            if (!game.ChapterTwo.ChapterTwoBooleans["justEnteredFort"] && !hut1.Finished && !hut.Finished && !hut2.Finished)
            {
                game.ChapterTwo.ChapterTwoBooleans["justEnteredFort"] = true;
                ...
                //game.ChapterTwo.NPCs["Napoleon"].QuestDialogue[game.ChapterTwo.NPCs["Napoleon"].DialogueState] = "The enemy does not know we're here yet. Quickly, clear this area of troops to secure our position!";
            ...
            if(game.ChapterTwo.ChapterTwoBooleans["westTrollKilled"] && !game.ChapterTwo.ChapterTwoBooleans["bombExploded"])
            {
                game.CurrentChapter.state = Chapter.GameState.Cutscene;
                game.ChapterTwo.ChapterTwoBooleans["bombExploded"] = true;
                game.ChapterTwo.fortRaid.SpecialConditions.Clear();
                game.ChapterTwo.fortRaid.SpecialConditions.Add("Investigate the aftermath", false);
            ...
            if (game.ChapterTwo.ChapterTwoBooleans["centralCommanderSpawned"])
            {
                ...
                if (commander != null && enemiesInMap.Count == 0 && !game.ChapterTwo.ChapterTwoBooleans["centralCommanderKilled"])
                {
                    ...
                    game.ChapterTwo.fortRaid.SpecialConditions.Clear();
                    game.ChapterTwo.fortRaid.SpecialConditions.Add("Protect ze horse", false);
            ...
            else if (horse != null && game.ChapterTwo.ChapterTwoBooleans["horseInCentral"])
