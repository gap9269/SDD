...
namespace ISurvived
{
    class TheJanitor : NPC
    {
        int moveFrame;
        int frameDelay = 5;
        Boolean zamboni = true;

        //--Constructor for quest NPC
        public TheJanitor(Texture2D sprite, List<String> d, Quest q, Rectangle r, Player play, SpriteFont f, Game1 g, String mName, String name,
            Boolean stat)
        ...
        public TheJanitor(Texture2D sprite, List<String> d, Rectangle r, Player play, SpriteFont f, Game1 g, String mName, String name, Boolean stat)
        ...
        public override Rectangle GetSourceRectangle(int frame)
        {
            ...
            {
                if(moveFrame < 8)
                    return new Rectangle(516 * moveFrame, 388, 516, 388);
                else
                    return new Rectangle(516 * (moveFrame - 8), 776, 516, 388);
        ...
        public void RideZamboni(float speed)
        {
            zamboni = true;
        ...
        public override void Draw(SpriteBatch s)
        {
            ...
            if (game.CurrentChapter.state != Chapter.GameState.Cutscene && game.CurrentChapter.CurrentMap.MapName == mapName)
            {
                ...
                else
                {
                    ...
                    if (game.CurrentChapter.TalkingToNPC == false && !zamboni)
                    {
