            ...
            switch (state)
            {
                ...
                case State.options:
                    ...
                    if (fadeOut.State == 2)
                    {
                        ...
                        game.CurrentChapter.CurrentMap = Game1.schoolMaps.maps["StoneFortWasteland"];
                        ...
                        Game1.Player.OwnedAccessories.Add( new SoloCup());
                        Game1.Player.OwnedHats.Add(new PartyHat());
                        Game1.Player.OwnedWeapons.Add(new HandSaw());
                        Game1.Player.OwnedWeapons.Add(new HandSaw());
                        Game1.Player.EquippedSkills.Add(SkillManager.AllSkills["Lightning Speak"]);
                        Game1.Player.EquippedSkills.Add(SkillManager.AllSkills["Crushing Realization"]);
                        Game1.Player.EquippedSkills.Add(SkillManager.AllSkills["Harsh Burn"]);
                ...
                case State.loadGame:
                    ...
                    if (fadeOut.State == 2)
                    {
                        ...
                        game.CurrentChapter.CurrentMap.LoadContent();
                        Bathroom.loadGameSound.CreateInstance().Play();
                    }
                ...
                case State.overwriteConfirm:
                    ...
                    if (fadeOut.State == 2)
                    {
                        ...
                        if (overwriteWithoutTutorial == true)
                        {
                            ...
                            game.CurrentChapter.CurrentMap = Game1.schoolMaps.maps["IntroToScience"];
                            game.CurrentChapter.CurrentMap.LoadContent();
                            Game1.Player.HasCellPhone = true;
