...
namespace ISurvived
{
    class Launch : Skill
    {
        ...
        public Launch(Texture2D sheet, Player play, Texture2D ico)
            : base(sheet, play, ico, true)
        {
            ...
            name = "Mopping Up";
            canUse = true;
            description = "Using the wise words of the Janitor, Daryl launches into the air and knocks enemies in front of him skyward.";
            fullCooldown = 150;
