...
namespace ISurvived
{
    public class ShockingStatementsCh3Demo : Skill
    {
        ...
        int chanceToStun = 5;
        int stunTime = 120;
        public ShockingStatementsCh3Demo(Texture2D sheet, Player play, Texture2D ico)
            : base(sheet, play, ico, false)
        {
            ...
            canUse = true;
            description = "Use your body as a lightning rod to deflect electricity in front of you and onto your enemies!";
            fullCooldown = 90;
        ...
        public void SetRectangles()
        {
            ...
            else
            {
                if (skillRank >= 12)
                    ...
                    shot1 = new Rectangle(player.VitalRecX - (400 + (0 * 100)), player.VitalRecY + 30, 400, 80);
            }
            #endregion
        }
        ...
        public override void Draw(SpriteBatch s)
        {
            ...
            //s.Draw(Game1.whiteFilter, shot1, Color.Red);
            ////Draw shots
