...
namespace ISurvived
{
    //public class ChapterTwoPointFive : Chapter
   // {
//       //NPCs
//        NPC alan;
//        NPC paul;
...
//        public ChapterTwoPointFive(Game1 g, ref Player p,
...
//        {
//            //player.EquippedSkills[0].SkillRank = 4;
//            //player.EquippedSkills[0].ApplyLevelUp();
//            //player.EquippedSkills[1].SkillRank = 4;
//            //player.EquippedSkills[1].ApplyLevelUp();
//            //player.EquippedSkills[2].SkillRank = 4;
//            //player.EquippedSkills[2].ApplyLevelUp();
//            //player.EquippedSkills[3].SkillRank = 4;
//            //player.EquippedSkills[3].ApplyLevelUp();
//            //cutsceneState = 7;
...
//                        //DEMO END
//                        if (nextMap == "Trolls Hut" && chapterTwoBooleans["demoEndPlayed"] == false)
//                        {
...
//                List<ItemForSale> items = new List<ItemForSale>() { new WeaponForSale(new MelonMallet(), .50f), new HatForSale(new GardeningHat(), .30f), new OutfitForSale(new IHateMelons(), .50f) };
