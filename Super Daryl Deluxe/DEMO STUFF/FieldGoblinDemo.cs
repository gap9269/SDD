...
namespace ISurvived
{
    public class GoblinDemo : Enemy
    {
        ...
        public GoblinDemo(Vector2 pos, String type, Game1 g, ref Player play, MapClass cur, EnemyLevel enemyLevel = EnemyLevel.ten)
            : base(pos, type, g, ref play, cur)
        {
            if (type == "Goblin" || type == "Field Goblin" || type == "Goblin Soldier" || type == "Nurse Goblin")
            {
