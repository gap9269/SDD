        ...
        public void RespawnCommanderSoldiers()
        {
            ...
            switch (game.chapterState)
            {
                case Game1.ChapterState.chapterTwo:
                    ...
                    if (enemyNamesAndNumberInMap["Goblin Soldier"] < 4)
                    {
                        Goblin ben = new Goblin(pos, "Goblin Soldier", game, ref player, this);
                        ben.Hostile = true;
        ...
        public override void Update()
        {
            ...
            if (game.ChapterTwo.ChapterTwoBooleans["horseInEast"])
            {
                ...
                if (horse.RecX > mapWidth)
                {
                    ...
                    StoneFortWest.horse.HasBeenHit = true;
                    horse = null;
            ...
            else if (game.ChapterTwo.ChapterTwoBooleans["eastCommanderSpawned"] && !game.ChapterTwo.ChapterTwoBooleans["eastCommanderKilled"] && commander != null)
            ...
            else
            {
                if (game.ChapterTwo.ChapterTwoBooleans["enemyReinforcementsSpawning"] == false || game.ChapterTwo.ChapterTwoBooleans["clearedEastHuts"] == false)
                {
                    ...
                    if (hutsDestroyed == 6 && game.ChapterTwo.ChapterTwoBooleans["clearedEastHuts"] == false)
                    {
                        if (game.ChapterTwo.ChapterTwoBooleans["clearedWestHuts"])
                        {
                            ...
                            game.ChapterTwo.NPCs["Napoleon"].QuestDialogue[game.ChapterTwo.NPCs["Napoleon"].DialogueState] = "Zhere is a big-shot gathering troops in ze West. Go stop him!";
