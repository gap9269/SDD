...
namespace ISurvived
{
    class ChapterTwoOpening : Cutscene
    {
        ...
        public ChapterTwoOpening(Game1 g, Camera cam, Player player)
            : base(g, cam, player)
        {
        }
        ...
        public override void LoadContent()
        {
            ...
            flashbackAndOpening = content.Load<Video>(@"Cutscenes\ChapterTwoOpening");
        }
