...
namespace ISurvived
{
    public class QuickRetortDemo : Skill
    {
        ...
        public QuickRetortDemo(Texture2D sheet, Player play, Texture2D ico)
        ...
        public override void Update()
        {
            ...
            if (attacking)
            {
                ...
                {
                    CheckCollisions(hitBox, damage, new Vector2(15, -6), 3 + (skillRank / 3), 3 +(skillRank / 3));
                }
            ...
            if (animationLength > 0 && !attacking)
            {
                ...
                {
                    if (checkPlatRec.Intersects(interactiveObjectsInMap[i].VitalRec) && interactiveObjectsInMap[i].Finished == false)
                    {
                        animationLength = 5;
                        player.VelocityX = 0;
                        attacking = true;
