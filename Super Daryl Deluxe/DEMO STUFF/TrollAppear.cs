...
namespace ISurvived
{
    class TrollAppearDemo : Cutscene
    {
        // ATTRIBUTES \\
        ...
        public TrollAppearDemo(Game1 g, Camera cam, Player player)
            : base(g, cam, player)
        {
        }
            ...
            switch (state)
            {
                ...
                case 2:
                    ...
                    if (firstFrameOfTheState)
                    {
                        ...
                        StoneFortWestDemo.horse.PositionX = 6000;
                        StoneFortWestDemo.horse.RecX = 6000;
                ...
                case 3:
                    ...
                    if (napoleon.Talking == false && (Game1.schoolMaps.maps["Stone Fort - West"] as StoneFortWestDemo).troll == null)
                    {
                        ...
                        (Game1.schoolMaps.maps["Stone Fort - West"] as StoneFortWestDemo).troll = new FieldTroll(new Vector2(6400, 135), "Field Troll", game, ref player, game.CurrentChapter.CurrentMap);
                        (Game1.schoolMaps.maps["Stone Fort - West"] as StoneFortWestDemo).troll.Hostile = true;
                        (Game1.schoolMaps.maps["Stone Fort - West"] as StoneFortWestDemo).troll.FacingRight = false;
                        (Game1.schoolMaps.maps["Stone Fort - West"] as StoneFortWestDemo).troll.SpawnWithPoof = false;
                        (Game1.schoolMaps.maps["Stone Fort - West"] as StoneFortWestDemo).troll.TimeBeforeSpawn = 0;
                        (Game1.schoolMaps.maps["Stone Fort - West"] as StoneFortWestDemo).troll.UpdateRectangles();
                        (Game1.schoolMaps.maps["Stone Fort - West"] as StoneFortWestDemo).troll.Alpha = 1;
                        game.CurrentChapter.CurrentMap.AddEnemyToEnemyList((Game1.schoolMaps.maps["Stone Fort - West"] as StoneFortWestDemo).troll);
                        LoadContent();
                        Sound.PlaySoundInstance(cutscene_troll_burst_through_wall, Game1.GetFileName(() => cutscene_troll_burst_through_wall));
                    }

                    if ((Game1.schoolMaps.maps["Stone Fort - West"] as StoneFortWestDemo).troll != null)
                        otherTimer++;
