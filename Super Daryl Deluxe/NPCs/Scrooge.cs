...
namespace ISurvived
{
    class Scrooge : NPC
    {
        public Boolean isScared = true;

        //--Constructor for quest NPC
        public Scrooge(Texture2D sprite, List<String> d, Quest q, Rectangle r, Player play, SpriteFont f, Game1 g, String mName, String name,
            Boolean stat)
        ...
        public Scrooge(Texture2D sprite, List<String> d, Rectangle r, Player play, SpriteFont f, Game1 g, String mName, String name, Boolean stat)
        ...
        public override Rectangle GetSourceRectangle(int frame)
        {
            if (isScared)
            {
                currentDialogueFace = "Scared";

                return new Rectangle(516+(516 * moveFrame), 0, 516, 388);
            }
