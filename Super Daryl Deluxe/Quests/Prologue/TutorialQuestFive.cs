...
namespace ISurvived
{
    public class TutorialQuestFive : Quest
    {
            ...
            : base(story)
        {
            ...
            questDialogue.Add("The Janitor's Closet is in the Art Hall, and his keys should be in there somewhere.");
            ...
            taskForQuestsPage = "Steal the Janitor's keys, then find a Textbook.";
