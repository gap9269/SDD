...
namespace ISurvived
{
    class CuttingCornersDemo : Skill
    {
        ...
        public CuttingCornersDemo(Texture2D sheet, Player play, Texture2D ico)
        ...
        public override void Use(Game1 g, Keys key)
        {
            ...
            if (justPressed == false)
            {
                ...
                if(skillRank >= 10)
                    ...
                    Sound.PlaySoundInstance(skillUseSounds["weapon_sword_barrage_lvl" + 2 + "_a_01"], "weapon_sword_barrage_lvl" + 2 + "_a_01", false);
