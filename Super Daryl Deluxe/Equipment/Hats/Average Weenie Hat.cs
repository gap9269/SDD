...
namespace ISurvived
{
    public class AverageWeenieHat : Hat
    {
        public AverageWeenieHat()
            : base()
        {
            health = 45;
            strength = 0;
            ...
            moveSpeed = 0;
            jumpHeight = 0;
            name = "Average Weenie Hat";
            level = 8;
            description = "The propeller runs on brain activity, in case you're wondering why it's stuck.";
