...
namespace ISurvived
{
    static class ContentLoader
    {
        ...
        public static Dictionary<String, SoundEffect> LoadSoundContent(this ContentManager contentManager, string contentFolder)
        {
            //Load directory info, abort if none
            DirectoryInfo dir = new DirectoryInfo(contentManager.RootDirectory + "\\" + contentFolder);
            if (!dir.Exists)
            ...
            foreach (FileInfo file in files)
            {
                ...
                result[key] = contentManager.Load<SoundEffect>(contentFolder + "/" + key);
            }
