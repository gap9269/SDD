...
namespace ISurvived
{
    public class StoneFortWestDemo : MapClass
    {
        ...
        public StoneFortWestDemo(List<Texture2D> bg, Game1 g, ref Player play)
            : base(bg, g, ref play)
        {
            mapWidth = 9000;
            mapHeight = 1160;
        ...
        public override void LoadContent()
        {
            ...
            if (game.ChapterTwoDemo.ChapterTwoBooleans["horseInWest"])
            {
            ...
            if (game.ChapterTwoDemo.ChapterTwoBooleans["bombExploded"] && Chapter.lastMap != "Stone Fort Wasteland")
            {
        ...
        public override void Update()
        {
            ...
            if (game.ChapterTwoDemo.ChapterTwoBooleans["horseInWest"])
            {
                ...
                if (game.ChapterTwoDemo.BossFight == false)
                    horse.Update();
                ...
                else if(!game.ChapterTwoDemo.ChapterTwoBooleans["trollSpawnedInWest"])
                {
                    horse.StopSound();
                    game.CurrentChapter.state = Chapter.GameState.Cutscene;
                    game.ChapterTwoDemo.fortRaid.SpecialConditions.Clear();
                    game.ChapterTwoDemo.fortRaid.SpecialConditions.Add("Kill the Troll", false);
            ...
            if (game.ChapterTwoDemo.ChapterTwoBooleans["bombExploded"] && enemiesInMap.Count > 0)
            {
                enemiesInMap.Clear();
                ResetEnemyNamesAndNumberInMap();
            }

            if (game.ChapterTwoDemo.ChapterTwoBooleans["enemyReinforcementsSpawning"] && enemiesInMap.Count < enemyAmount && (!game.ChapterTwoDemo.ChapterTwoBooleans["westCommanderSpawned"] || game.ChapterTwoDemo.ChapterTwoBooleans["horseInWest"]) && !game.ChapterTwoDemo.ChapterTwoBooleans["trollSpawnedInWest"])
            {
                RespawnGroundEnemies();
            }
            else if (game.ChapterTwoDemo.ChapterTwoBooleans["trollSpawnedInWest"] && !game.ChapterTwoDemo.ChapterTwoBooleans["westTrollKilled"])
            {
                RespawnTrollEnemies();

                if (!enemiesInMap.Contains(troll))
                {
                    game.ChapterTwoDemo.ChapterTwoBooleans["westTrollKilled"] = true;

                    Chapter.effectsManager.AddInGameDialogue("Get out of zhere before ze bomb explodes!", "Napoleon", "Normal", 400);
                    game.ChapterTwoDemo.fortRaid.SpecialConditions.Clear();
                    game.ChapterTwoDemo.fortRaid.SpecialConditions.Add("Leave the area", false);
            ...
            else if (game.ChapterTwoDemo.ChapterTwoBooleans["westCommanderSpawned"] && !game.ChapterTwoDemo.ChapterTwoBooleans["westCommanderKilled"] && commander != null)
                RespawnCommanderSoldiers();

            if (game.ChapterTwoDemo.ChapterTwoBooleans["westCommanderSpawned"])
            {
                if (!game.ChapterTwoDemo.ChapterTwoBooleans["westCommanderKilled"] && commander == null)
                {
                    enemiesInMap.Clear();
                    ResetEnemyNamesAndNumberInMap();
                    ...
                    {
                        commander = new AnubisCommanderDemo(new Vector2(3500, platforms[0].RecY - 600), "Commander Anubis", game, ref player, this, new Rectangle(200, 300, mapWidth - 400, 500));
                ...
                if (commander != null && commander.Health <= 0 && !game.ChapterTwoDemo.ChapterTwoBooleans["westCommanderKilled"])
                {
                    game.ChapterTwoDemo.ChapterTwoBooleans["westCommanderKilled"] = true;

                    if (game.ChapterTwoDemo.ChapterTwoBooleans["eastCommanderKilled"] && !game.ChapterTwoDemo.ChapterTwoBooleans["centralCommanderSpawned"])
                    {
                    ...
                    else
                    {
                        ...
                        game.ChapterTwoDemo.ChapterTwoBooleans["eastCommanderSpawned"] = true;
                        game.ChapterTwoDemo.fortRaid.SpecialConditions.Clear();
            ...
            {
                if (game.ChapterTwoDemo.ChapterTwoBooleans["enemyReinforcementsSpawning"] == false || game.ChapterTwoDemo.ChapterTwoBooleans["clearedWestHuts"] == false)
                {
                    int hutsDestroyed = 0;
                    ...
                    if (hutsDestroyed == 5 && game.ChapterTwoDemo.ChapterTwoBooleans["clearedWestHuts"] == false)
                    {
                        if (game.ChapterTwoDemo.ChapterTwoBooleans["clearedEastHuts"])
                        {

                            game.ChapterTwoDemo.NPCs["Napoleon"].QuestDialogue[game.ChapterTwoDemo.NPCs["Napoleon"].DialogueState] = "Zhere is a big-shot gathering troops in ze East. Go stop him!";
                        ...
                        game.ChapterTwoDemo.ChapterTwoBooleans["clearedWestHuts"] = true;
                    }
        ...
        public override void SetDestinationPortals()
        {
            ...
            portals.Add(toCentral, StoneFortCentralDemo.ToFortWest);
            portals.Add(ToEast, StoneFortEastDemo.ToWest);
            portals.Add(ToWasteland, StoneFortWastelandDemo.ToWest);
        }
        ...
        public override void Draw(SpriteBatch s)
        {
            ...
            if (game.ChapterTwoDemo.ChapterTwoBooleans["trollSpawnedInWest"] && !game.ChapterTwoDemo.ChapterTwoBooleans["bombExploded"])
            {
                if(background[1] != background2Hole)
                    background[1] = background2Hole;
            }
            if (game.ChapterTwoDemo.ChapterTwoBooleans["horseInWest"] && horse != null)
                horse.DrawHorse(s);
        }
...
null, null, null, null, Game1.camera.Transform);
            ...
            if (!game.ChapterTwoDemo.ChapterTwoBooleans["bombExploded"])
            {
                ...
                if (game.ChapterTwoDemo.ChapterTwoBooleans["trollSpawnedInWest"])
